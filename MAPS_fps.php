 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="MAPS_fps.php"</script>'; 
     ...
     <div id="menu">
      ...
      <br />  
           <div class="container-fluid " >  
                ...
                <?php  
                $query = "SELECT * FROM games WHERE genre=4 ORDER BY id ASC";  
                ...
                <div class="col-sm-4">  
                     <form method="post" action="MAPS_fps.php?action=add&id=<?php echo $row["id"]; ?>" >  
