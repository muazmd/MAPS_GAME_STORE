...
$connect = new mysqli($dbHost, $dbUsername, $dbPassword, $dbName); 
 //$connect = mysqli_connect("den1.mysql2.gear.host", "mapsstore1", "Nt49z511_jG?", "mapsstore1");  
    ...
    $_SESSION['counter'] = $_SESSION['counter'] +1;
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="MAPS_openworld.php"</script>'; 
     ...
     <div id="menu">
      ...
      <br />  
           <div class="container-fluid " >  
                ...
                <?php  
                $query = "SELECT * FROM games WHERE genre=3 ORDER BY id ASC";  
                ...
                <div class="col-sm-4">  
                     <form method="post" action="MAPS_openworld.php?action=add&id=<?php echo $row["id"]; ?>" >
