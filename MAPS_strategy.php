 ...
 {  
      ...
      {  
           ...
           {  
                ...
                echo '<script>window.location="MAPS_strategy.php"</script>'; 
...
<body>
     ...
     <div id="menu">
      ...
      <br />  
           <div class="container-fluid " >  
                ...
                <?php  
                $query = "SELECT * FROM games WHERE genre=2 ORDER BY id ASC";  
                ...
                <div class="col-sm-4">  
                     <form method="post" action="MAPS_strategy.php?action=add&id=<?php echo $row["id"]; ?>" >  
                          <div style=" background-color:#171A21;  ; padding:16px;" align="center ">  
                              <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" /> <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['image']); ?>" />   
 ...
 <center>
     <form method="post">
         <div class="chbtn"><button name="checkout" class="btn btn-outline-success" >Proceed to Checkout</button></div>   
         </form> </center> 
